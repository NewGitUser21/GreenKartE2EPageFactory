...
public class base {
	...
	public static WebDriver initializeDriver() throws IOException  //void changed to WebDriver
	{
		...
		//C:\Users\DELL\eclipse-workspace\TestNG Practice\GreenKartE2E\src\test\java\TestNG\GreenKartE2E\data.properties
		//This****3rd way to use base properties file***********
		String directoryPath = System.getProperty("user.dir");
		FileInputStream fis = new FileInputStream(directoryPath+"/src/test/java/TestNG/GreenKartE2E/data.properties");
